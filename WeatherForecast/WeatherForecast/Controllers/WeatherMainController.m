...
- (NSArray *)commonCities
{
    ...
    return [YGWeatherDataTool commonCities];
}
...
- (NSMutableDictionary *)cachedWeatherDatas {
    ...
    if (!_cachedWeatherDatas) {
        _cachedWeatherDatas = [NSMutableDictionary dictionaryWithDictionary:[YGWeatherDataTool cachedWeatherDatas]];
    }
...
- (void)setupWeatherToolBar {
    ...
    WeatherToolBar *weatherToolBar = [[WeatherToolBar alloc] initWithLocationCity:[[YGLocationTool sharedInstance] currentLocationCity]
...
- (void)reloadWeatherData {
    ...
    [self loadWeatherDataOfCityname:cityname cityid:[YGWeatherDataTool cityidOfCityname:cityname]];
}
...
- (void)prepareForLoadWeatherDataOfCity:(NSInteger)index {
    ...
    if ([[YGLocationTool sharedInstance] currentLocationCity]) {
        if (index == 0) {
            cityname = [[YGLocationTool sharedInstance] currentLocationCity];
        } else {
...
- (void)loadWeatherDataOfCityname:(NSString *)cityname cityid:(NSString *)cityid {
    ...
    [YGWeatherDataTool loadWeatherDataCityname:cityid cityid:cityid success:^(NSDictionary *weatherData) {
...
- (void)commonCityControllerDidOpenAutoLocation {
    ...
    [[YGLocationTool sharedInstance] resetLocation];
